...
public class baza{
    ...
    static void menu() throws IOException{
        ...
        System.out.println("PROJEKT MINI BAZY DANYCH 2024, AUTOR: ALAN KALKOWSKI, NR. INDEKSU: 20449");
        System.out.println("===============================");
        System.out.println("    1. Otwórz bazę danych");
        System.out.println("    2. Utwórz nową bazę danych");
        System.out.println("    3. Przeglądaj bazę danych");
        System.out.println("    4. Sortuj bazę danych");
        System.out.println("    5. Usuń bazę danych");
        ...
        switch(choice){
            ...
            case "3":
                ...
                break;
            case "4":
                System.out.println("Wybrana opcja 4");
                if(filePath != null){
                    sortDatabase();
                    clearScreen();
                }
                else{
                    System.out.println("Obecnie nie jest otwarty żaden plik, sortowanie niemożliwe");
                }
                break;
            case "5":
                System.out.println("Wybrana opcja 5");
                deleteDatabase();
                clearScreen();
                break;
            case "6":
    ...
    static void browseDatabase() throws IOException {
        ...
        do {
            ...
            System.out.println("Y - dane w górę; B - dane w dół; A - dodaj nowy obiekt; D - usuń bieżący obiekt; M - modyfikuj obiekt");
            System.out.println("F - przejdź na początek; L - przejdź na koniec; X - wyjdź z trybu przeglądania");
